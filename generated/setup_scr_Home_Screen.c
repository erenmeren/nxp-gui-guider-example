...
void setup_scr_Home_Screen(lv_ui *ui){
	...
	//Write codes Home_Screen_ncf
	ui->Home_Screen_ncf = lv_img_create(ui->Home_Screen_main_container, NULL);

	//Write style LV_IMG_PART_MAIN for Home_Screen_ncf
	static lv_style_t style_Home_Screen_ncf_main;
	lv_style_reset(&style_Home_Screen_ncf_main);

	//Write style state: LV_STATE_DEFAULT for style_Home_Screen_ncf_main
	lv_style_set_image_recolor(&style_Home_Screen_ncf_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_Home_Screen_ncf_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_Home_Screen_ncf_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->Home_Screen_ncf, LV_IMG_PART_MAIN, &style_Home_Screen_ncf_main);
	lv_obj_set_pos(ui->Home_Screen_ncf, 245, 175);
	lv_obj_set_size(ui->Home_Screen_ncf, 64, 54);
	lv_obj_set_click(ui->Home_Screen_ncf, true);
	lv_img_set_src(ui->Home_Screen_ncf,&_NFCLogo_alpha_64x54);
	lv_img_set_pivot(ui->Home_Screen_ncf, 0,0);
	lv_img_set_angle(ui->Home_Screen_ncf, 0);
	...
	lv_obj_set_pos(ui->Home_Screen_full_wifi_icon, 260, 9);
	lv_obj_set_size(ui->Home_Screen_full_wifi_icon, 15, 15);
	lv_obj_set_click(ui->Home_Screen_full_wifi_icon, true);
	lv_img_set_src(ui->Home_Screen_full_wifi_icon,&_wifiFull_alpha_15x15);
