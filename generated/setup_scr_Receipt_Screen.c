...
void setup_scr_Receipt_Screen(lv_ui *ui){
	...
	//Write codes Receipt_Screen_img_1
	ui->Receipt_Screen_img_1 = lv_img_create(ui->Receipt_Screen_main_container, NULL);

	//Write style LV_IMG_PART_MAIN for Receipt_Screen_img_1
	static lv_style_t style_Receipt_Screen_img_1_main;
	lv_style_reset(&style_Receipt_Screen_img_1_main);

	//Write style state: LV_STATE_DEFAULT for style_Receipt_Screen_img_1_main
	lv_style_set_image_recolor(&style_Receipt_Screen_img_1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_Receipt_Screen_img_1_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_Receipt_Screen_img_1_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->Receipt_Screen_img_1, LV_IMG_PART_MAIN, &style_Receipt_Screen_img_1_main);
	lv_obj_set_pos(ui->Receipt_Screen_img_1, 245, 175);
	lv_obj_set_size(ui->Receipt_Screen_img_1, 64, 54);
	lv_obj_set_click(ui->Receipt_Screen_img_1, true);
	lv_img_set_src(ui->Receipt_Screen_img_1,&_NFCLogo_alpha_64x54);
	lv_img_set_pivot(ui->Receipt_Screen_img_1, 0,0);
	lv_img_set_angle(ui->Receipt_Screen_img_1, 0);
	...
	lv_label_set_text(ui->Receipt_Screen_timer_label, "15");
	...
	lv_style_set_text_font(&style_Receipt_Screen_timer_label_main, LV_STATE_DEFAULT, &lv_font_Prompt_Medium_26);
	...
	lv_obj_set_pos(ui->Receipt_Screen_timer_label, 18, 190);
	lv_obj_set_size(ui->Receipt_Screen_timer_label, 40, 0);
	...
	lv_obj_set_pos(ui->Receipt_Screen_qr_container, 85, 75);
	lv_obj_set_size(ui->Receipt_Screen_qr_container, 150, 150);
