...
void setup_scr_Loading_Screen(lv_ui *ui){
	...
	//Write codes Loading_Screen_img_1
	ui->Loading_Screen_img_1 = lv_img_create(ui->Loading_Screen, NULL);

	//Write style LV_IMG_PART_MAIN for Loading_Screen_img_1
	static lv_style_t style_Loading_Screen_img_1_main;
	lv_style_reset(&style_Loading_Screen_img_1_main);

	//Write style state: LV_STATE_DEFAULT for style_Loading_Screen_img_1_main
	lv_style_set_image_recolor(&style_Loading_Screen_img_1_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_Loading_Screen_img_1_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_Loading_Screen_img_1_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->Loading_Screen_img_1, LV_IMG_PART_MAIN, &style_Loading_Screen_img_1_main);
	lv_obj_set_pos(ui->Loading_Screen_img_1, 71.5, 57);
	lv_obj_set_size(ui->Loading_Screen_img_1, 177, 161);
	lv_obj_set_click(ui->Loading_Screen_img_1, true);
	lv_img_set_src(ui->Loading_Screen_img_1,&_Printing_alpha_177x161);
	lv_img_set_pivot(ui->Loading_Screen_img_1, 0,0);
	lv_img_set_angle(ui->Loading_Screen_img_1, 0);
